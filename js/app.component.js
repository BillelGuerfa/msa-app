    ...
    return {
        ...
        execute: function() {
            AppComponent = (function () {
                function AppComponent(_el, _authService, _router, _employeService, _featureService, _zone) {
                    this._el = _el;
                ...
                AppComponent = __decorate([
                    core_1.Component({
                        ...
                        providers: [users_barrel_1.AuthService,
                            ...
                            shared_barrel_1.DateService,
                            agentPrestation_barrel_1.OrganismeService,
                            shared_barrel_1.NotificationService],
                    ...
                    router_1.RouteConfig([
                        ...
                        { path: '/rdvs', as: "SearchRdvs", component: assistante_barrel_1.SearchRdvsComponent },
                        ...
                        //Therapeute Routes : ------------------------------------------------------------
                        { path: '/seance-new', as: "FicheSeanceForm", component: therapeute_barrel_1.FicheSeanceFormComponent },
                        { path: '/historique-visites', as: "HistoriqueVisites", component: therapeute_barrel_1.HistoriqueVisitesComponent }
                    ]), 
